...
//            }
//
//            CNode a = m_children.elementAt(best);
//            CNode b = m_children.elementAt(secondBest);
...
//
//                for (int i = 0; i < m_children.size(); i++) {
//                    CNode existingChild = m_children.elementAt(i);
//                    if (existingChild != a) {
...
//                    }
//                }
//                CNode sa = m_children.elementAt(best);
//                CNode sb = m_children.elementAt(secondBest);
